...
Car::Car()
    : positionsX(), positionsY(), boostUsage(), velX(0), velY(0), nbMoves(0),
      nbFailures(0), boosts(0), position(0), finishPosition(4), debug(false) {
  driver = new QProcess;
}
...
void Car::fillTank(int value) { this->gasoline = value; }

bool Car::isOutOfGas() const { return !gasoline; }
